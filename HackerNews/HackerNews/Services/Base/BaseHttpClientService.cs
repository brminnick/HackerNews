...
namespace HackerNews
{
    public abstract class BaseHttpClientService
    {
        ...
        static readonly Lazy<HttpClient> _clientHolder = new Lazy<HttpClient>(() => CreateHttpClient(TimeSpan.FromSeconds(20)));
        #endregion
        ...
        protected static void UpdateActivityIndicatorStatus(bool isActivityInidicatorRunning)
        {
            ...
            Debug.WriteLine(_networkIndicatorCount);
        }
